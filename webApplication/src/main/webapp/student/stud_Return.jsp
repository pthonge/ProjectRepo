...
background-size: cover;
 ...
 <font align="right" style="font-size: 19px; color: rgb(102, 102, 255); font-family: arial,helvetica,sans serif;">
           <br><a href="stud_index.jsp">Home</a> | <a href="stud_RequestNewBook1.jsp">Request a new Book</a> |
...
<!-- </div> -->
     ...
     <form name="mainForm" action="../ReturnBook" method="post" onsubmit="return validateForm()">
     <br/><br/><br/>
     ...
     <br/>     <br/>
      ...
      <table border="1">         
               <tr bgcolor="#ddd">
                <td><font style="font-size: 15px; color: rgb(102, 102, 255); font-family: arial,helvetica,sans serif;">Enter Book ID</font></td><td><input type="text" name="B_Id"></td>
      	      </tr > 
              <tr bgcolor="#ddd">
