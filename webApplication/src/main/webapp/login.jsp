 ...
 <form name="mainForm" method="Post" action="j_security_check" onsubmit="return validateForm()"  > <!--  -->
  <center>
                       <p>
                         ...
                         <br><table border="1">
                        <tr><td> <strong> User ID</strong></td><td> <input type="text" size="20" name="j_username" /><br></td></tr>
                        <tr><td>  <strong> Password </strong></td><td><input type="password" size="20" name="j_password" /></td></tr>
                         </table>
                         <br>
